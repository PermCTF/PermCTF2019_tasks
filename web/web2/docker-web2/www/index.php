...
<body>
<script>
	if (document.cookie.indexOf("mode=") >= 0) {} else {
		document.cookie = "mode=guest"
	}
</script>
<div id="wrapper">

	<div id="topBar">
		<div><b></b><a href="http://orteil.dashnet.org" target="_blank"></a><a href="http://dashnet.org" target="_blank"></a></div>
		<div><a href="http://twitter.com/orteil42" target="_blank"></a></div>
		<div><a href="http://orteil42.tumblr.com" target="_blank"></a></div>
		<div><a href="http://forum.dashnet.org" target="_blank"></a></div>
		<div style="position:relative;"><div ></div><a class="blueLink" href="http://www.redbubble.com/people/dashnet" target="_blank"></a></div>
		<div><a href="http://orteil.dashnet.org/randomgen/" target="_blank"></a></div>
		<div id="links" class="hoverer">

			<div class="hoverable">
			<a href="../" target="_blank" id="linkVersionLive"></a>
			<a href="beta" target="_blank" id="linkVersionBeta"></a>
			<a href="http://orteil.dashnet.org/cookieclicker/v10466" target="_blank" id="linkVersionOld"></a>
			<a href="http://orteil.dashnet.org/experiments/cookie/" target="_blank"></a>
			</div>
		</div>
	</div>
...
if (isset($_COOKIE['mode'])){
    if ($_COOKIE['mode'] ==='admin'){
        echo '<script>alert("Welcome back, admin. Your flag is: PermCTF{its_time_for_a_tea_with_cookies}")</script>';
}else {
        echo '<script>alert("Welcome back, guest")</script>';
    }}
?>
